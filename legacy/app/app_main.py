...
# USERNAME_PASSWORD_PAIRS = [['fce','esgrima']]
...
orig_url2 = 'https://drive.google.com/file/d/1NRJYMnWfG8cU3anv41Ymi8jWJSYooW_U/view?usp=sharing'
#
...
features = [{'label': 'Posición final', 'value': 'POS'},
            ...
            {'label': 'Victoria en el 1er combate de poule', 'value': 'PM1V%'},
            {'label': 'Victoria en el 1er y 2do combate de poule', 'value': 'PM1&2V%'}]
    ...
    if yaxis_indres == 'POS':
        return dict(data=traces, layout=go.Layout(title='{}'.format(yaxis_indres),
                                                  ...
                                                  yaxis=dict(title='{}'.format(yaxis_indres),
                                                             autorange="reversed")))
    # if yaxis_indres== 'PTR' or yaxis_indres == 'PMTR' or yaxis_indres=='TTR':
    #    return dict(data=traces,layout=go.Layout(title='{}'.format(yaxis_indres),
    #                                         legend_orientation="h",
    #                                         #xaxis=dict(title='date'),
    #                                         yaxis=dict(title='{}'.format(yaxis_indres),
