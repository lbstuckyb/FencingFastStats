...
h1 = pd.read_excel('./results/a28.xlsx', sheet_name='Hoja1', skiprows=1, header=1)  # poules
h2 = pd.read_excel('./results/a28.xlsx', sheet_name='Hoja2')  # resultados de la poule
h3 = pd.read_excel('./results/a28.xlsx', sheet_name='Hoja3')  # tablas preliminares
h4 = pd.read_excel('./results/a28.xlsx', sheet_name='Hoja4')  # tablas 256 a 16
h5 = pd.read_excel('./results/a28.xlsx', sheet_name='Hoja5')  # tablas T8 a final
h6 = pd.read_excel('./results/a28.xlsx', sheet_name='Hoja6')  # resultados finales
h7 = pd.read_excel('./results/a28.xlsx', sheet_name='Hoja7')  # info de la compe
